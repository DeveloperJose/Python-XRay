...
class ShuffleNetV2OneShot(nn.Module):
    ...
    def __init__(self, input_size=224, first_conv_channels=16, last_conv_channels=1024, n_classes=2, op_flops_path="./data/op_flops_dict.pkl", affine=False):
        super().__init__()
    ...
    def get_candidate_flops(self, candidate):
        ...
        rest_flops = self._op_flops_dict["rest_operation"][(self.stage_channels[-1], 1000,
